...
public abstract interface SysGroupAPI {
	...
	public abstract Long getTotalCountRecord(String paramString, HashMap<String, Object> paramHashMap,
			HashMap<String, String> paramHashMap1);

	public abstract List<Object[]> getGroupInfoBySQL(Paging<SysGroupVo> paramPaging, String paramString,
			HashMap<String, Object> paramHashMap, HashMap<String, Class> paramHashMap1);

	public abstract String buildSqlByCondition(String paramString, Map<String, Object> paramMap,
