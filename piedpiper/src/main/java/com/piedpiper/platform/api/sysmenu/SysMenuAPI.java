...
public abstract interface SysMenuAPI
{
  ...
  public abstract <T> T getSysMenusTlById(String paramString1, String paramString2, TypeReference<T> paramTypeReference);
  ...
  public abstract List<Map<String, Object>> recurgetSysMenuInfoByParentId(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5);
  ...
  public abstract List<SysMenuVo> getAllSubObjectInPermisson(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, Set<String> paramSet);
  ...
  public abstract String getIndexElementVlign(String paramString1, SecurityUser paramSecurityUser, SecurityMenu paramSecurityMenu, String paramString2);
  ...
  public abstract String getTraditionalIndexElementVlign(String paramString1, SecurityUser paramSecurityUser, SecurityMenu paramSecurityMenu, String paramString2);
  ...
  public abstract String getLeftTreeMenus(String paramString1, SecurityUser paramSecurityUser, SecurityMenu paramSecurityMenu, String paramString2);
