...
public abstract interface MobileAPI
{
  ...
  public abstract MobileAppVersionDTO getNewMobileAppVersionByAppIdAndPlatform(String paramString1, String paramString2);
  ...
  public abstract List<MobileUpdateSmartDTO> smartUpdate(String paramString1, String paramString2, String paramString3);
}
