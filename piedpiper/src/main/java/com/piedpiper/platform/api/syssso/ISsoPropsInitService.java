...
public abstract interface ISsoPropsInitService {
	public abstract void initSsoProps() throws Exception;

	public abstract void initFillerConfigProps() throws Exception;

	public abstract void initSsoMap() throws Exception;

	public abstract void initccSsoMap() throws Exception;
