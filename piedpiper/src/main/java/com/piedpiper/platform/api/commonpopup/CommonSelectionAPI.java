...
public abstract interface CommonSelectionAPI
{
  ...
  public abstract Node getOrgNodeBySysOrgId(String paramString1, String paramString2, String paramString3, Map<String, Object> paramMap);
  
  public abstract Node getOrgNode(String paramString1, String paramString2, Map<String, Object> paramMap);
  
  public abstract List<Node> getSysDeptNodesByOrgId(String paramString1, String paramString2, String paramString3, Map<String, Object> paramMap);
}
