...
public class Db2Dialect extends AbstractDialect {
	...
	public String pageSql(String selectSql, int maxResults, int firstResult) {
		...
		StringBuffer pagingSelect = new StringBuffer(selectSql.length() + 100)
				.append(selectSql.substring(0, startOfSelect)).append("select * from ( select ")
				.append(getRowNumberSql(selectSql));
