 ...
 public abstract class AbastractExcelImport
   implements IcommInfo, IExcelImport
 {
   ...
   protected Object getContentFromExcelByPOI(Cell cell) throws Exception { if (cell == null) {
       return "";
     }
     ...
     throws Exception
   {
     try
     {
       ...
       this.message = MessageFormat.format("共{0}条记录，成功导入:{1}条,失败:{2}条.", new Object[] { Integer.valueOf(this.rowTotal), Integer.valueOf(this.successRows), Integer.valueOf(this.failRows) });
     }
     catch (Exception e) {
   ...
   protected abstract void doPretreatment()
     throws Exception;
   
   protected abstract void doValidateExcelTemplet()
     throws Exception;
   
   protected abstract void doImportByExcutor();
   
   protected abstract void doGenerateErrorExcel()
     throws Exception;
 }
