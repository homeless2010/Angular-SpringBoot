 ...
 {
   private static Logger logger = org.slf4j.LoggerFactory.getLogger(PlatformProperties.class);
   ...
   private static void loadProperties()
     throws Exception
   {
     ResourcePatternResolver resourceResolver = new org.springframework.core.io.support.PathMatchingResourcePatternResolver();
     
     Resource res = resourceResolver.getResource("classpath:platform6.properties");
     ...
     Resource[] resources = resourceResolver.getResources("classpath*:platform6_ext.properties");
