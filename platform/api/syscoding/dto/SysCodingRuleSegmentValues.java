...
public class SysCodingRuleSegmentValues extends BeanDTO implements Serializable {
	...
	private String dependValues;
	private String comSegmentValueId;
	...
	public String getDependValues() {
		return this.dependValues;
	}

	public void setDependValues(String dependValues) {
		this.dependValues = dependValues;
	}

	public String getComSegmentValueId() {
		return this.comSegmentValueId;
	}

	public void setComSegmentValueId(String comSegmentValueId) {
		this.comSegmentValueId = comSegmentValueId;
	}
	...
	public String getLogTitle() {
		if ((this.logTitle == null) || (this.logTitle.equals(""))) {
			return "SYS_CODING_RULE_SEGMENT_VALUES";
		}
