...
public class SysCodingRuleSerial extends BeanDTO implements Serializable {
	...
	public BigDecimal getMaxSerial() {
		return this.maxSerial;
	}

	public void setMaxSerial(BigDecimal maxSerial) {
