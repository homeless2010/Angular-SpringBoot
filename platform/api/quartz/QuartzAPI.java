...
public abstract interface QuartzAPI {
	...
	public abstract Map<String, Object> loadJobs(int paramInt1, int paramInt2, String paramString1, String paramString2,
			String paramString3);

	public abstract Map<String, Object> loadJobsByGroup(String paramString);

	public abstract boolean addJob(Job paramJob, String paramString, List<Variable> paramList) throws Exception;

	public abstract boolean updateJob(Job paramJob, String paramString, List<Variable> paramList) throws Exception;

	public abstract boolean deleteJobById(String paramString) throws Exception;
