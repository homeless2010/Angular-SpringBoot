...
public class SysUserLimitIp extends BeanDTO implements BaseCacheBean {
	...
	public Map<String, ?> returnCacheKey() {
		...
		map.put("PLATFORM6_USERLIMITIP_USERID_USERTYPE_IPTYPE_" + this.userLimitUserId + "_" + this.limitUserType + "_"
				+ this.limitTypeIpType, this.id);
		return map;
	}
