 package com.piedpiper.platform.core.mybatis.shard.plugin;
 
 import com.piedpiper.platform.core.mybatis.shard.builder.ShardConfigHolder;
 import com.piedpiper.platform.core.mybatis.shard.builder.ShardConfigParser;
 import com.piedpiper.platform.core.mybatis.shard.converter.SqlConverterFactory;
 import com.piedpiper.platform.core.mybatis.shard.util.ReflectionUtils;
   ...
   implements Interceptor
 {
   ...
   public Object intercept(Invocation invocation) throws Throwable {
     ...
     if (isShouldParse(mapperId)) {
       ...
       String regEx = "ALTER|PRIMARY|COMMENT|alter|primary|comment";
