 ...
 public class ShardConfigParser
 {
   ...
   private static final String SHARD_CONFIG_DTD = "com.piedpiper.platform.core/mybatis/shard/builder/shardbatis-config.dtd";
   private static final Map<String, String> DOC_TYPE_MAP = new HashMap();
   
   static { DOC_TYPE_MAP.put("http://shardbatis.avicit.com/dtd/shardbatis-config.dtd".toLowerCase(), "com.piedpiper.platform.core/mybatis/shard/builder/shardbatis-config.dtd");
     
 
     DOC_TYPE_MAP.put("-//shardbatis.avicit.com//DTD Shardbatis 2.0//EN".toLowerCase(), "com.piedpiper.platform.core/mybatis/shard/builder/shardbatis-config.dtd");
   }
