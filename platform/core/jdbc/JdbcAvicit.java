...
public class JdbcAvicit {
	...
	public NamedParameterJdbcOperations getNamedParameterJdbcOperations() {
		if (this.namedParameterJdbcOperations == null) {
			this.namedParameterJdbcOperations = new org.springframework.jdbc.core.namedparam.NamedParameterJdbcTemplate(
					this.jdbcTemplate);
		}
	...
	public <T> void getDatesByPageForMap(Page<T> page, String sql, Map<String, Object> param, String tableName,
		...
		if (param == null) {
			...
			long count = ((Long) getNamedParameterJdbcOperations()
					.queryForObject("select count(1) from (" + sql + ") t_avicit", mapSqlParam, Long.class))
							.longValue();
	...
	public <T> void getDatasByPage(Page<T> page, String sql, Map<String, Object> param, Class<T> clazz,
			String tableName, DecorativeSQL ds) {
		MapSqlParameterSource mapSqlParam = new MapSqlParameterSource();
		if (param != null) {
			String whereSql = " WHERE ";
			List<String> condition = buildeQueryParam(param, tableName, mapSqlParam, null);
	...
	public <T> void getDatasByPage(Page<T> page, Map<String, Object> sqlMap, Class<T> clazz) {
		...
		long count = ((Long) getNamedParameterJdbcOperations().queryForObject("select count(1) " + countSql + "", vv,
	...
	public List<Map<String, Object>> queryForMapJavaWithParam(String sql, Map<String, Object> param, String tableName,
			DecorativeSQL ds) {
	...
	public List<Map<String, Object>> queryForMap(String sql, Map<String, String> map,
			ColumnPropertyRowMapper stringRowMapper) {
		return query(sql, map, stringRowMapper);
	}
	...
	public <T> void page(Page<T> page, String sql, Map<String, String> map, RowMapper<T> rowMapper) {
		...
		this.logger.debug("COUNT-SQL: select count(1) from (" + sql + ")");
		long count = ((Long) getNamedParameterJdbcOperations()
				.queryForObject("select count(1) from (" + sql + ") t_avicit", map, Long.class)).longValue();
		this.logger.debug("PAGE-SQL: " + sqll);
	...
	public void pageForMap(Page<Map<String, Object>> page, String sql, Map<String, String> map,
			StringRowMapper stringRowMapper) {
		page(page, sql, map, stringRowMapper);
	}

	public void pageForMap(Page<Map<String, Object>> page, String sql, Map<String, String> map,
			ColumnPropertyRowMapper columnPropertyRowMapper) {
		page(page, sql, map, columnPropertyRowMapper);
	}

	private List<String> buildeQueryParam(Map<String, Object> param, String tableName,
			MapSqlParameterSource mapSqlParam, Map<String, String> map) {
