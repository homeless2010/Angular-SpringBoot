...
public class TreeUtils {
	public static TreeNode parseToTree(List<TreeNode> list) throws Exception {
		...
		for (TreeNode node : treeMap.values()) {
			...
			if ("-1".equals(parentId)) {
				...
				if (null == parentNode)
					throw new Exception("找不到父节点[" + text + "/" + parentId + "],树不完整，请检查数据！");
	...
	public static TreeNode parseToTree(List<TreeNode> list, boolean isOpen) throws Exception {
		TreeNode rootNode = null;
	...
	public static TreeNode parseToTree(List<TreeNode> list, boolean isOpen, String parentFlg) throws Exception {
		TreeNode rootNode = null;
